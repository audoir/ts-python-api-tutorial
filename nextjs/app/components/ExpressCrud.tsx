...
export default function ExpressCrud() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      if (editingItem) {
        ...
        const res = await fetch(`${EXPRESS_API}/api/items/${editingItem.id}`, {
          method: "PUT",
  ...
  async function handleDelete(id: number) {
    ...
    setLoading(true);
    try {
      const res = await fetch(`${EXPRESS_API}/api/items/${id}`, {
        method: "DELETE",
      });
